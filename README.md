...
| Agent | 模式 | 职责 |
|-------|------|------|
| product-owner | primary | 和用户对话，产品待办 |
| scrum-master | subagent | Sprint 推进 |
| developer | subagent | 开发 |
| qa | subagent | 测试 |
| architect | subagent | 架构 |
| ui-ux-designer | subagent | 界面设计 |
| devops | subagent | 运维部署 |
| security-engineer | subagent | 安全 |
| data-engineer | subagent | 数据工程 |
| network-engineer | subagent | 网络 |
